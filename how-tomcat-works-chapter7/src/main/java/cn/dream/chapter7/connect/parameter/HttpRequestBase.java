...
import cn.dream.chapter7.connect.ParameterMap;
import cn.dream.chapter7.util.RequestUtil;
...
public abstract class HttpRequestBase extends RequestBase implements HttpRequest, HttpServletRequest {
    ...
    public String getDecodedRequestURI() {
        ...
        return RequestUtil.URLDecode(requestURI);
    }

    @Override
    public ServletRequest getRequest() {
        return (HttpRequestFacade) facade;
    }
